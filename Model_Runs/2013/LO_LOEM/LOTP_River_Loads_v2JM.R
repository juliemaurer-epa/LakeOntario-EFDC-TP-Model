...
TP_InputFile <- "/work/GLHABS/GreatLakesEco/LakeOntario/LOEM/LOEM_TP_Daily_Loads_2013.xlsx"

# Set path and name of netcdf containing TP loads.
# JM: copied TP_RiverLoads_2013.nc and renamed to new version.
Netcdf_InputFile <- "/work/GLFBREEZ/Lake_Ontario/River_Loads/TP_RiverLoads_LOEM_2013.nc"
